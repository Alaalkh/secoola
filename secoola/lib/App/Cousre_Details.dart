...
class Curriculum extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      children: [
        CurriculumWidgets(Name: "Introduction         ", duraion: "00.53 mins"),
        CurriculumWidgets(Name: "Design Thingking", duraion: "05.25 mins"),
        CurriculumWidgets(Name: "Improving Design", duraion: "05.36 mins")
      ],
    );
  }
}
          ...
          Row(
            children: [
              Container(
                ...
                child: Text(
                  "Price",
                  style: TextStyle(color: const Color(0xfffA9AEB2), fontSize: 16.sp),
                ),
              ),
              Container(
                ...
                child: Text(
                  "\$150",
                  style: TextStyle(color: const Color(0xfff00A9B7), fontSize: 24.sp),
                ),
              )
            ],
          ),
