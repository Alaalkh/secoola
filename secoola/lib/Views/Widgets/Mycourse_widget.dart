              ...
              children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 6.w, top: 22.h),
                          child: const Text(
                        ...
                        Row(
                          children: [
                            Container(
                              height: 20.h,
                              alignment: Alignment.center,padding: EdgeInsets.only(left: 11.w,right: 11.w),
                              decoration: BoxDecoration(
                                  color: Ligthblue,
                                  borderRadius:
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 88.w, top: 11.h),
                      child: Text(
                        "Due Time",
                        style: TextStyle(fontSize: 12.sp, color: darkgrey),
                      ),
